...
/* 
    This file defines a JFrame that lets the user add colored shapes to
    ...
    by the frame, namely:  ShapeCanvas, Shape, RectShape, OvalShape,
    and RoundRectShape.
    
    The JFrame class defined in this file is virtually identical
    to the JApplet defined in ShapeDrawWithMenus.java.  This behavior
    should be changed if the frame is opened by an applet.
    
    The ShapeDrawFrame class defined in this file has a main()
    routine, so it can be run as a stand-alone application.  The
    main() routine simply creates and opens a frame.
...
public class AShapeDrawFrame extends JFrame {
   ...
   public AShapeDrawFrame() {  
      ...
      try {
         ...
         // Security check added 12-Jan-2006.  A security exception
         // is generated when the frame is launched by the applet,
         // ShapeDrawLauncher.
      }
